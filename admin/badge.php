...
if (isset($_POST['edit'])) {
       ...
       $sqlUpdate = "UPDATE badge SET title = :title, des = :des, iconUrl = :iconUrl WHERE id = :id";
       ...
       header("Location: badge?updated=true");
        exit;
...
<body class="bg-gray-50">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex-1 overflow-auto p-6 readable-font">
                <div class="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow" x-data="badgeTable()" x-init="init()">
                        ...
                        <table class="min-w-max divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-100 text-gray-700 font-semibold">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left">Icon Url</th>
                            ...
                            <tbody>
                                <template x-for="row in paginatedRows()" :key="row.id">
                                    <tr class="hover:bg-gray-50 border-b">
                                        ...
                                        <td class="px-4 py-2" x-text="row.iconUrl"></td>
                                ...
                                <form action="" method="post">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" x-model="modalData.iconUrl" name="iconUrl"
                                                class="w-full border rounded-lg p-2" :readonly="!isEditing"
                                                :class="!isEditing ? 'bg-gray-50' : ''">
                                        </div>
    ...
    const badgeFromPHP = <?php echo json_encode($rows, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
    ...
    function badgeTable() {
        return {
            ...
            init() {
                this.rows = badgeFromPHP.map(badge => {
                    return {
                        id: badge.id,
                        title: badge.title,
                        des: badge.des,                       
            ...
            saveEdit() {
                ...
                if (i !== -1) {
                    ...
                    this.rows[i] = {
                        ...
                        iconUrl: this.modalData.iconUrl,
