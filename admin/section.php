<?php 
    ...
    if (isset($_POST['edit'])) {
        ...
        $sql = "UPDATE section SET courseId = ?, title = ?, position = ? WHERE id = ?";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$courseId, $title, $position, $id]);
    
        header('Location: section?updated=1');
        exit;
    }
...
<body class="bg-gray-50">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex-1 overflow-auto p-6 readable-font">
                <div class="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow" x-data="sectionTable()" x-init="init()">
                 ...
                 <div class="flex justify-end mb-4">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                        <h1 class="text-xl font-semibold text-gray-800">Section History</h1>
                            ...
                            <tbody>
                                <template x-for="row in paginatedRows()" :key="row.id">
                                    <tr class="hover:bg-gray-50 border-b">
                                        ...
                                        <td class="px-4 py-2" x-text="row.courseId"></td>
                                ...
                                <form action="" method="post">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="1" x-model.number="modalData.courseId" name="courseId"
    ...
    const sectionFromPHP = <?php echo json_encode($rows, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
    ...
    function sectionTable() {
        return {
            ...
            init() {
                this.rows = sectionFromPHP.map(section => {
                    return {
                        id: section.id,
            ...
            saveEdit() {
                ...
                if (i !== -1) {
                    ...
                    this.rows[i] = {
                        ...this.rows[i],
                        courseId: this.modalData.courseId,
